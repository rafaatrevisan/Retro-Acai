...
<head>
  ...
  <title>Retrô Açaí - Editar Produto</title>
</head>
<body>
<main>
  ...
  <section class="container-form">
      ...
      <div class="container-radio">
        <div>
          ...
          <input type="radio" id="acai" name="tipo" value="Açaí" <?= $produto->getTipo() == "Açaí"? "checked" : "" ?>>
        </div>
        <div>
          <label for="sorvete">Sorvete</label>
          <input type="radio" id="sorvete" name="tipo" value="Sorvete" <?= $produto->getTipo() == "Sorvete"? "checked" : "" ?>>
        </div>
    </div>
